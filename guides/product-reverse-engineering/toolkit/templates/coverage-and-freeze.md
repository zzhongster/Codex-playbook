...
status: "REPLACE_WITH_WORKFLOW_OR_ARTIFACT_LIFECYCLE_STATUS"
evidence_references: []
...
| --- | --- | --- | --- | --- | --- | --- |
| structure/product/semantic/runtime/data/permission/integration/non-functional/trace | REPLACE_WITH_TOTALS | REPLACE_WITH_COVERED | REPLACE_WITH_UNKNOWN | REPLACE_WITH_CONFLICTS | REPLACE_WITH_EXCLUSIONS | REPLACE_WITH_RISK_COUNTS |
